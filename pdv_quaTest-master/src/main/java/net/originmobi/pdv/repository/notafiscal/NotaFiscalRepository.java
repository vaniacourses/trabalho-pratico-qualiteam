...
public interface NotaFiscalRepository extends JpaRepository<NotaFiscal, Long> {
	...
	@Modifying
	@Query(value = """
            insert into nota_fiscal (modelo, tipo, natureza_operacao, serie, emissor_codigo, destinatario_codigo, tipo_emissao, \
            verProc, frete_tipo_codigo, finalidade_codigo, totais_codigo, data_cadastro) values (:modelo, :tipo, :natureza, :serie, :emissor,\
             :destinatario, :tipoEmissao, :verProc, :frete, :finalidade, :totais, :cadastro)\
            """, nativeQuery = true)
